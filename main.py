...
async def on_ready():
    try:
        ...
        print(
            f"{Style.BRIGHT}{Fore.GREEN}The server has been copied successfully!"
        )
        print(
            f"{Style.BRIGHT}{Fore.BLUE}Visit our Discord server: {Fore.YELLOW}https://discord.gg/NTUseX63Hy{Style.RESET_ALL}"
        )
        print(
